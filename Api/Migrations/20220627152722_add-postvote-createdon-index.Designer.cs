...
namespace Api.Migrations
{
    ...
    [Migration("20220627152722_add-postvote-createdon-index")]
    partial class addpostvotecreatedonindex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Data.Entities.PostScore", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            About = "",
                            CreatedOn = new DateTime(2022, 6, 27, 15, 27, 22, 372, DateTimeKind.Utc).AddTicks(2833),
            ...
            modelBuilder.Entity("Api.Data.Entities.PostScore", b =>
                {
                    b.HasOne("Api.Data.Entities.Post", "Post")
                        .WithOne("Scores")
                        .HasForeignKey("Api.Data.Entities.PostScore", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
